@extends('layout')
@section('title', 'Checkout | BoiGhor')
@section('content')
        			...
        			<div class="col-lg-12">
        				<div class="wn_checkout_wrap">
        					...
        					<div class="checkout_login">
                                <!--
        						<form class="wn__checkout__form" action="{{url('/customer-login')}}" method="post">
                                    {{ csrf_field() }}
						    ...
						    <div class="payment">
						        <div class="che__header" role="tab" id="headingFour">
						          	<a class="collapsed checkout__title" data-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
							            <span>PayPal <img src="{{asset('front-end/images/icons/payment.png')}}" alt="payment images"> </span>
						          	</a>
						        </div>
