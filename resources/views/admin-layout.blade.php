					...
					<ul class="nav pull-right">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                            		...
                            		foreach($message as $msg)
                            		 ...
                            		 { ?>
                                    <a href="{{URL::to('/show-msg/'.$msg->id)}}">
										<span class="avatar"><img src="{{('back-end/img/avatar.jpg')}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	{{ $msg->firstname }}
										     </span>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a href="{{URL::to('/logout')}}"><i class="halflings-icon off"></i> Logout</a>
								</li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li>
							<a href="{{URL::to('/dashboard')}}"><i class="icon-bar-chart"></i>
								<span class="hidden-tablet"> Dashboard</span>
							</a>
						</li>	
						<li>
							<a href="{{URL::to('/all-category')}}"><i class="icon-envelope"></i>
							<span class="hidden-tablet"> All Category</span>
						    </a>
						</li>
						<li>
							<a href="{{URL::to('/add-category')}}"><i class="icon-tasks"></i>
							<span class="hidden-tablet"> Add Category</span>
						    </a>
						</li>
						<li>
							<a href="{{URL::to('/all-manufacture')}}"><i class="icon-eye-open"></i>
								<span class="hidden-tablet"> All Publications</span>
							</a>
						</li>
						<li>
							<a href="{{URL::to('/add-manufacture')}}"><i class="icon-dashboard"></i>
								<span class="hidden-tablet"> Add Publication</span>
							</a>
						</li>
						<li>
							...
							<ul>
								<li>
									<a class="submenu" href="{{URL::to('/all-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All products</span>
									</a>
								</li>

								<li>
									<a class="submenu" href="{{URL::to('/add-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add products</span>
									</a>
								</li>
						...
						<li>
							<a href="{{URL::to('/manage-order')}}"><i class="icon-list-alt"></i>
								<span class="hidden-tablet"> Manage order</span>
							</a>
						</li>
						<li>
							<a href="{{URL::to('/blog')}}"><i class="icon-font"></i>
								<span class="hidden-tablet"> Create Blog</span>
							</a>
						</li>
						<li>
